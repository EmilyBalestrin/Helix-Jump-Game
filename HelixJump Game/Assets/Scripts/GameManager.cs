...
public class GameManager : MonoBehaviour
{
    ...
    public static int score = 0; //pontua??o atual
    public static int highScore = 0; //maior pontua??o feita
    ...
    public TextMeshProUGUI nextLevelText; //texto do pr?ximo nivel
    ...
    private void Awake()
    {
        ...
        //pegar dados da mem?ria do dispositivo
    ...
    void Update()
    {
        ...
        if (gameOver)
        {
            ...
            //implementar mec?nica de pontua??o
